const variantStyles: Record<string, string> = {
  ...
  untested: "bg-zinc-100 text-zinc-600 dark:bg-zinc-700/30 dark:text-zinc-400",
  ...
  release: "bg-cyan-50 text-cyan-700 dark:bg-cyan-400/10 dark:text-cyan-300",
  preview: "bg-violet-50 text-violet-700 dark:bg-violet-400/10 dark:text-violet-300",
  "self-built": "bg-rose-50 text-rose-700 dark:bg-rose-400/10 dark:text-rose-300",
